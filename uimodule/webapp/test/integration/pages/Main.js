sap.ui.require([
  ...
  var sViewName = "fiorital.com.testUiTable.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of fiorital.com.testUiTable"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title fiorital.com.testUiTable"
            });
        }
      }
